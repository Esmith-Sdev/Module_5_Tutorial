...
const items = ["Macaroni and Cheese", "Spaghetti", "Fried Chicken"];
  ...
  return (
    <>
      <div>
        ...
        <h2>
          Welcome to this beatuiful restaurant {openStatus ? "Open" : "Closed"}
        </h2>
      </div>
      <main>
        <img
          src={chef}
          height={200}
          alt="A photo of a chef giving a thumbs up."
        />
        <ul>
          {dishes.map((dish) => (
...
function App() {
  ...
  return (
    <div>
      ...
      <Header name="Eddie" year={new Date().getFullYear()} />
